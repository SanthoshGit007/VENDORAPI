...
# -------------------------------------------------
# Deta Space uses Secrets (Environment Variables)
# -------------------------------------------------
DB_CONFIG = {
...
# -------------------------------------------------
# Upload Folder (Deta provides persistent storage)
# -------------------------------------------------
...
def get_conn():
    """Create MySQL connection with proper error handling"""
    try:
...
# -------------------------------------------------
# Deta Space runs with its own port automatically
# -------------------------------------------------
